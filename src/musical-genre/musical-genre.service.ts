...
export class MusicalGenreService {
  ...
  private async saveAndReturnGenreWithRelations(
    genre: MusicalGenre,
  ): Promise<MusicalGenre> {
  ...
  async createMusicalGenreService(
    createMusicalGenreInput: CreateMusicalGenreInput,
  ) {
    const newMusicalGenre = this.musicalGenreRepository.create(
  ...
  async updateMusicalGenreService(
    id: string,
    updateMusicalGenreInput: UpdateMusicalGenreInput,
  ) {
